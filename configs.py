...
__Note: I can only process one video at a time. As my server is Heroku, my health is not good. If you have any issues with Adding Watermark to a Video, then please Report at [Support Group](https://t.me/Yeageristbots).__

Desgined by @Amalbiju154
"""
	PROGRESS = """
Percentage : {0}%
Done ✅: {1}
